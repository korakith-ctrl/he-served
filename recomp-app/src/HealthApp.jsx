...
import {
  connectRealtime, firebaseConfigured, observeFirebaseAuth, replaceRealtimeStore, signInFirebase,
  signOutFirebase, writeRealtimeLog, writeRealtimePreferences, writeRealtimeWorkout,
...
function SettingsModal({open,onClose,preferences,onPreferences,syncInfo,onSignIn,onSignOut}) {
...
export default function HealthApp() {
  ...
  return <div className="recomp-app">
    ...
    <SettingsModal open={settingsOpen} onClose={()=>setSettingsOpen(false)} preferences={store.preferences} onPreferences={updatePreferences} syncInfo={syncInfo} onSignIn={signInFirebase} onSignOut={signOutFirebase}/>
