...
แท็บ **บันทึกประจำวัน** แสดงเงินเข้าออกที่เกิดจริงในรอบเงินเดือน บันทึกเองได้และผูกกับแผนรายรับรายจ่ายเดิมเพื่อเทียบยอดจริงกับยอดที่ยังคาดว่าจะเกิด รายการชำระหนี้ส่วนตัวและรายการชำระระหว่างบุคคลที่ยืนยันแล้วเชื่อมจากข้อมูลต้นทางโดยไม่สร้างธุรกรรมซ้ำ; รายการรอยืนยันแสดงแยกจากยอดจริง ย้อนชำระแล้วไม่รวมในยอดจริง ดูรายละเอียดและกติกาคำนวณใน [DAILY_CASHFLOW_DESIGN.md](./DAILY_CASHFLOW_DESIGN.md)
