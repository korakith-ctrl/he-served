...
หน้าหลักใช้ progressive disclosure เพื่อลดการเลื่อนยาว: ปฏิทินเงินเข้า–ออกใช้พื้นที่ร่วมกันและสลับมุมมองได้, รายการหนี้โหลดเพิ่มครั้งละ 6 รายการ และหน้า **รายรับ–รายจ่าย** แบ่งเป็นส่วนตัว รายการที่เชื่อมกับคนอื่น และปฏิทิน โดยข้อมูลทั้งหมดเข้าถึงได้ภายในหนึ่งขั้นจากหน้าสรุป

## รันในเครื่อง

### หน้าตาแอป

ธีมใช้พื้นขาวอุ่น ตัวอักษรสีหมึก และเขียวเข้มเป็นสีหลัก เน้นยอดเงิน พื้นที่ว่าง และเส้นแบ่งบาง ๆ ตั้งแต่หน้าเข้าสู่ระบบ พื้นที่ข้อตกลง ไปจนถึงการเงินส่วนตัว สีเตือนยังแยกตามสถานะของรายการ

ไฟล์ `src/minimal.css` เป็นธีมที่โหลดหลัง `src/styles.css` ซึ่งเก็บเลย์เอาต์และสถานะของฟีเจอร์ รองรับมือถือและ `prefers-reduced-motion` ไอคอนเว็บและ PWA อยู่ใน `public/`
...
## Push Notification สำหรับ PWA

เปิด/ปิดการแจ้งเตือนจากปุ่มกระดิ่ง ตั้งหมวด เวลาเตือน ช่วงพัก และอุปกรณ์ได้ ดูค่าที่ต้องตั้งและขั้นตอน deploy ใน [PUSH_SETUP.md](./PUSH_SETUP.md)
